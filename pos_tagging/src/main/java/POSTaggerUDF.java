...
public class POSTaggerUDF extends EvalFunc<String> {
    ...
    POSModel model = new POSModelLoader().load(new File("/home/avi/Desktop/college/sem8/nosql/assignment2/opennlp-en-ud-ewt-pos-1.0-1.9.3.bin")); //Edit path to the pre-trained model file
