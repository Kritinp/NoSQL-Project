...
def multiword_tokenexp(input_text):
	input_file = "multiword_tokenexp/input.txt"
	f = open(input_file, "w")
	f.write(input_text)
	f.close()
	
	# Set the path to your Pig script
	pig_script_path = "multiword_tokenexp/script.pig"

	# delete ouput directory if exists
	output_directory = "multiword_tokenexp/output/"
